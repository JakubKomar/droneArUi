...
\projectinfo{
  ...
  keywords.en={\todo{To do: překlad }}, % klíčová slova v anglickém jazyce / keywords in english
  %keywords.en={Here, individual keywords separated by commas will be written in English.},
  % Abstrakt / Abstract
  abstract.cs={Práce se zaobírá návrhem, implementací a testováním uživatelského rozhraní v prostředí rozšířené reality na platformě HoloLens 2. Toto rozhraní má za úkol usnadnění pilotáže dronu. Hlavní náplní práce je analýza dopadů použití tohoto rozhraní a zodpovězení hypotézy, zda-li rozšířená realita v reálném prostředí opravdu usnadní pilotáž a v jaké míře. }, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  abstract.en={\todo{To do: překlad }}, % abstrakt v anglickém jazyce / abstract in english
