...
/// </date>
/// <summary>
/// upravený vlc example skript (skript byl součástí knihovny VLC), který pøehrává rtmp streamy, stream je nakonfigurován pro nízkou latenci, zastavuje pøehrávání pokud je deaktivován kvùli optimalizaci
/// </summary>
