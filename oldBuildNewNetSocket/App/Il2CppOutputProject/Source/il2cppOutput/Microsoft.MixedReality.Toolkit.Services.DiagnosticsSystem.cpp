...
IL_01db:
	{
		...
		*((float*)L_60) = (float)((float)il2cpp_codegen_subtract((float)L_61, (float)L_63));
		...
		Color_t119BCA590009762C7223FDD3AF9706653AC84ED2  L_67 = MixedRealityToolkitVisualProfiler_CalculateFrameColor_mC4FE6FD4C59E22ABE394DEE50D66C34056D88798(__this, (((int32_t)((int32_t)L_66))), /*hidden argument*/NULL);
