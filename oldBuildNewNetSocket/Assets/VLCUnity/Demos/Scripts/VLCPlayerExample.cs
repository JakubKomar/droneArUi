...
public class VLCPlayerExample : MonoBehaviour
{
	...
	public void Open()
	{
        ...
        mediaPlayer.Media.AddOption(":rtsp-caching=50");
        Play();
	}
	...
	void CreateLibVLC()
	{
		...
		libVLC = new LibVLC(enableDebugLogs: true, "--clock-synchro=1", "--low-delay", "--verbose=2", "--no-osd", "--network-caching=0"); //You can customize LibVLC with advanced CLI options here https://wiki.videolan.org/VLC_command-line_help/
